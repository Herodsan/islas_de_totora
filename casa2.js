...
function crearCasaTotora(x, y, z){
    ...
    let colorTotora = new THREE.MeshPhongMaterial({
        color: 0xd2b16d
    });
    ...
    let matP = new THREE.MeshPhongMaterial({
        color: 0x000000,
...
//   casa = crearCasa(0,1.9,-2);
//   casa.rotation.y = 10*(Math.PI/180);

//   let geometry = new THREE.CylinderGeometry(0.05, 0.05, 2.5, 32);
//     let material = new THREE.MeshPhongMaterial({ color: 0xffff00});
//     let cilindro = new THREE.Mesh(geometry, material);
//     cilindro.position.set(0, 2, 4);
//     cilindro.rotation.z = 30*(Math.PI/180)
//     scene.add(cilindro);
crearCasaTotora(0,-2,3);
